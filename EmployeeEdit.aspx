<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="EmployeeEdit.aspx.cs" Inherits="EmployeeEdit" %>
 ...
 <asp:UpdatePanel ID="UpdatePanel2" runat="server">
   <triggers>
    ...
    <section class="content-header">
         <h1>
              <span class="auto-style3">Edit Employee Form</span>
           </h1>       
                      ...
                      <table class="datepicker-inline">
                          ...
                          <tr>
                              ...
                              <td class="auto-style11">
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEmpId" Display="None" ErrorMessage="EmpId Required" ForeColor="Red"></asp:RequiredFieldValidator>
                              </td>
                              <td class="auto-style11">
                                  &nbsp;</td>
                          ...
                          <tr>
                              ...
                              <td class="auto-style30">
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtFName" Display="None" ErrorMessage="Firest Name Required" ForeColor="Red"></asp:RequiredFieldValidator>
                              </td>
                              <td class="auto-style30">
        ...
        TargetControlID="txtHiredDate" PopupButtonID="ImageButton2"/>
                          ...
                          <tr>
                              ...
                              <td class="auto-style30">
                                  &nbsp;</td>
                              <td class="auto-style30">
                                  <asp:TextBox ID="txtEndDate" runat="server" Height="25px" Width="177px" Visible="False"></asp:TextBox>
