<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="AdminDashboard.aspx.cs" Inherits="Dashboard" %>
...
<asp:Label ID="lblEXP" runat="server" Text=""></asp:Label>
            ...
            <div class="col-lg-3 col-xs-4">
             <div class="small-box bg-aqua">
              <h2 class="small-box-footer">Data Imported</h2>
                <div class="inner">
                 
                      <table class="nav-justified">
                          <tr>
                              <td>
                                  <asp:Label ID="Label11" runat="server" Text="MAX Date:- " Font-Size="14pt"></asp:Label>
                                  <asp:Label ID="maxDAte" runat="server" Font-Size="14pt"></asp:Label>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <asp:Label ID="Label12" runat="server" Text="MAX Time:- " Font-Size="14pt"></asp:Label>
                ...
                <a href="/AttendanceAndLeave/getData.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
              </div> 
<%--<div class="col-lg-3 col-xs-4">
             <div class="small-box bg-red">
