<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="LeaveSettingReport.aspx.cs" Inherits="EmpAttReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
         <h1>
              <span class="auto-style3">Leave Setting Report Form</span>
           </h1>       
                              ...
                              <td colspan="5">
                                  ...
                                  <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                                   ...
                                   <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                                       TypeName="LeaveSettingTableAdapters."></asp:ObjectDataSource>
                                   </td>
                          </tr>
                          <tr>
