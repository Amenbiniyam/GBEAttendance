<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="AllLeaveReport.aspx.cs" Inherits="AllLeaveReport" %>
                              ...
                              <td colspan="5">
                                  ...
                                  <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                                      ...
                                      <LocalReport ReportEmbeddedResource="AttendanceAndLeaveManagementSystem.ReportP.rdlc" 
                                          ReportPath="AllLeaveReport.rdlc">
                                          <DataSources>
                                   ...
                                   <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                                       SelectMethod="GetData" TypeName="AllLeaveTableAdapters.empLeaveTableAdapter">
