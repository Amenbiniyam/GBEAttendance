<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="AutDashboard.aspx.cs" Inherits="AutDashboard" %>
       ...
       <div class="row">
                        ...
                        <tr>
                            <td class="style6">
                                ...
                                <asp:Label ID="lblBal" runat="server" Font-Size="14pt"></asp:Label>
                                  <asp:Label ID="Label13" runat="server" Font-Bold="False" Font-Size="14pt" 
                                    Text=" ]"></asp:Label>
                            </td>
                            <td class="style2">
                                &nbsp;</td>
            ...
            <div class="col-lg-3 col-xs-4">
              ...
              <div class="small-box bg-yellow">
                <h2 class="small-box-footer">Attendance Report The Last 30 days</h2>    
                <div class="inner">
                        ...
                        <tr>
                            <td class="style5">
                                ...
                                <asp:Label ID="lblLate" runat="server" Font-Size="14pt"></asp:Label>
                                   <asp:Label ID="Label6" runat="server" Text=" Punches"></asp:Label>
                            </td>
                            <td class="style1">
                            </td>
                        </tr>
                        <tr>
                            <td class="style4">
                                ...
                                <asp:Label ID="lblUNJ" runat="server" Font-Size="14pt"></asp:Label>
                                   <asp:Label ID="Label8" runat="server" Text=" Punches"></asp:Label>
                            </td>
                            <td class="user-image">
                            </td>
                        </tr>
...
<asp:Label ID="lblEXP" runat="server" Text=""></asp:Label>
            ...
            <div class="col-lg-3 col-xs-4">
             <div class="small-box bg-red">
              <h2 class="small-box-footer">Unauthorized Leave Request</h2>
                <div class="inner">
                      ...
                      <table class="nav-justified">
                          <tr>
                              <td>
                                    ...
                                    <a class="small-box-footer" href="UnauthorizedData.aspx" 
                                      style="color: #FFFFFF">
                                      
                                  <asp:Label ID="Label11" runat="server" Text="Leave Request:- " Font-Size="14pt"></asp:Label>
                                  <asp:Label ID="maxDAte" runat="server" Font-Size="14pt"></asp:Label>
                          ...
                          <tr>
                              <td>
                              <a class="small-box-footer" href="RevUnauthorizedData.aspx" 
                                      style="color: #FFFFFF">
                                  <asp:Label ID="Label12" runat="server" Font-Size="14pt"  
                                      Text="Leave Reversal:- " ></asp:Label>
                                  <asp:Label ID="maxTime" runat="server" Font-Size="14pt" ></asp:Label>
                                   More info <i class="fa fa-arrow-circle-right"></i></a>
                              </td>
                          </tr>
                      </table>
