...
public partial class PositionHome : System.Web.UI.Page
{
   ...
   MainDAL MAD = new MainDAL();
        ...
        protected void Edit(object sender, EventArgs e)
        {
            using (GridViewRow row = (GridViewRow)((ImageButton)sender).Parent.Parent)
            {
                ...
                Session["posId"] = Int32.Parse(row.Cells[0].Text);
                Session["posName"] = row.Cells[1].Text;
                Session["posDescription"] = row.Cells[2].Text.Trim();
                ...
                Response.Redirect("PositionEdit.aspx");


                //lblID.Text = row.Cells[0].Text;
                //txtPositionName.Text= row.Cells[1].Text;
        ...
        protected void Delete(object sender, EventArgs e)
        {
            using (GridViewRow row = (GridViewRow)((ImageButton)sender).Parent.Parent)
            {
                ...
                try
                {
                    DA.deletePosition(Int32.Parse(row.Cells[0].Text));
