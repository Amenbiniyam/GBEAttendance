<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="DataAttReport.aspx.cs" Inherits="DataAttReport" %>
                  ...
                  <div class="box-body">
                    ...
                    Width="16px" CausesValidation="False"  />
                              ...
                              <td class="style31">
                                  ...
                                  <asp:TextBox ID="txtName" runat="server" AutoPostBack="True" Height="25px" 
                                      ontextchanged="txtName_TextChanged" TabIndex="1" Width="250px"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="style36">
                              ...
                              <td colspan="5">
                                  ...
                                  <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                                   ...
                                   <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
                                       TypeName="DataALLTableAdapters."></asp:ObjectDataSource>
                                   </td>
                          </tr>
                          <tr>
