       ...
       MainDAL MAD = new MainDAL();
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if(dsFP.Tables[0].Rows[0][0].ToString()=="NO")
                {
                ...
                else
                {
                    ...
                    while (k <= coun)
                    {
                        ...
                        for (int i = 0; i < dsSCH.Tables[0].Rows.Count; i++)
                        {
                            ...
                            DataSet dsTime = DA.selectSCTime(empId.ToString(), date, dateFR, dateTO);
                    ...
                    {
                        status = "Status=" + "'" + ddlStatus.SelectedItem.ToString() + "'";
