<%@ Page Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="RevUnauthorizedData.aspx.cs" Inherits="RevUnauthorizedData" Title="Untitled Page" %>
    ...
    <table bgcolor="White">
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td>
                <asp:Button ID="butUaAll" runat="server" onclick="butUaAll_Click" 
    ...
    ForeColor="#333333">
                        ...
                        <Columns>
                            <asp:TemplateField>
                             ...
                             <asp:TemplateField   ItemStyle-Width = "30px" HeaderText = "View/Delete" >
   <ItemTemplate>
            <asp:ImageButton CausesValidation="false" ID="lnkEdit" runat="server" ImageUrl="~/Images/Edit.png" OnClick="Edit" ToolTip="Edit"  />
             <asp:ImageButton ID="LinkButton1" runat="server" ImageUrl="~/Images/Delete.png" ToolTip="Reject" OnClick = "Delete"  OnClientClick="return confirm('Are you sure you want to delete this record?');"  /> 
