...
public partial class CashIndemnityReport : System.Web.UI.Page
{
    ...
    AttDAL DA = new AttDAL();
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (txtDep.Text == "" )
                {
                    lblMSG.Text = "Select Department from the Tree ";
                ...
                else
                {
                        ...
                        DataSet ds = DAL.leaveReportTeller(depName, DateTime.Parse(txtHiredDate.Text), DateTime.Parse(txtEndDate.Text));

                        DataTable dt = new DataTable();
                     //  EmpId, Full_Name, SUM(Days) AS NoOfDays,Status,DepartmentName,LeaveType
                        ...
                        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            row["Desc"] = "Cash Indeminity Allowance Report";
                            row["EmpId"]=ds.Tables[0].Rows[i][0].ToString();
                            row["FullName"] = ds.Tables[0].Rows[i][1].ToString();
                            row["NoOfDays"]=ds.Tables[0].Rows[i][2].ToString();
                            row["Status"]=ds.Tables[0].Rows[i][3].ToString();
                            row["DepartmentName"]=ds.Tables[0].Rows[i][4].ToString();
                            row["LeaveType"] = ds.Tables[0].Rows[i][5].ToString();
                            dt.Rows.Add(row);
                    ...
                    //GridView1.DataSource = ds;
                        ...
                        ReportDataSource datasource = new ReportDataSource("tblCash", dt);
