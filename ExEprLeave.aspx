<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="ExEprLeave.aspx.cs" Inherits="ExEprLeave" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
         <h1>
              <span class="auto-style3">Extend Expired Leave Form</span>
           </h1>       
                      ...
                      <table class="datepicker-inline">
                          ...
                          <tr>
                              ...
                              <td class="auto-style10">
                                  <asp:TextBox ID="txtEmpId" runat="server" Height="25px" Width="201px"></asp:TextBox>
                          ...
                          <tr>
                              <td class="auto-style22" colspan="8">
                                  ...
                                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AttendanceManagmentConnectionString %>" SelectCommand="SELECT * FROM [tblExLeave] ORDER BY [EmpID] "></asp:SqlDataSource>
                                  <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" Height="250px">
                                          <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                              DataKeyNames="EmpID"  AllowPaging="True" AllowSorting="True"  
                                              class="table table-bordered table-striped"  Width="423px" PageSize="5" 
                                              DataSourceID="SqlDataSource1" CssClass="table-striped">
               <Columns>
